    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 md:py-8">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6">
          {/* Upload Card */}
          <div className="bg-white rounded-xl shadow-md border border-slate-200 p-6 hover:shadow-xl hover:scale-[1.02] transition-all duration-300">
          ...
          <Link to="/vault" className="block">
            <div className="bg-white rounded-xl shadow-md border border-slate-200 p-6 hover:shadow-xl hover:scale-[1.02] transition-all duration-300 h-full">
        ...
        {/* Statistics */}
        <div className="mt-6 md:mt-8 bg-white rounded-xl shadow-md border border-slate-200 p-6">
